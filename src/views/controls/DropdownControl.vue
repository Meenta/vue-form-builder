...
export default {
    ...
    methods: {
        retrieveOptionLists() {
            ...
            // is it http/https?
            if (
                this.control.apiURL.indexOf("http://") < 0 &&
                this.control.apiURL.indexOf("https://") < 0
            ) {
                throw new TypeError(
                    "[Dropdown] Rest-API Endpoint must be valid http/https URL."
                );
            }
        ...
        defaultValue: {
            ...
            get: function () {
                return this.control.defaultValue
                    ? this.control.defaultValue.toLowerCase()
                    : "^_mt_slct_plchlr";
            },
            // setter
            set: function () {},
